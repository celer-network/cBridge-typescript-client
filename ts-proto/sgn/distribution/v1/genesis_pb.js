...
goog.exportSymbol('proto.sgn.distribution.v1.ValidatorSlashEventRecord', null, global);
/**
 ...
 * @constructor
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sgn.distribution.v1.ValidatorSlashEventRecord, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sgn.distribution.v1.ValidatorSlashEventRecord.displayName = 'proto.sgn.distribution.v1.ValidatorSlashEventRecord';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.toObject = function(opt_includeInstance) {
  return proto.sgn.distribution.v1.ValidatorSlashEventRecord.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEventRecord} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.toObject = function(includeInstance, msg) {
  var f, obj = {
    validatorAddress: jspb.Message.getFieldWithDefault(msg, 1, ""),
    height: jspb.Message.getFieldWithDefault(msg, 2, 0),
    period: jspb.Message.getFieldWithDefault(msg, 3, 0),
    validatorSlashEvent: (f = msg.getValidatorSlashEvent()) && sgn_distribution_v1_distribution_pb.ValidatorSlashEvent.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEventRecord}
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sgn.distribution.v1.ValidatorSlashEventRecord;
  return proto.sgn.distribution.v1.ValidatorSlashEventRecord.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEventRecord} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEventRecord}
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sgn.distribution.v1.ValidatorSlashEventRecord.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEventRecord} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getValidatorAddress();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.getValidatorAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEventRecord} returns this
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.setValidatorAddress = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.getHeight = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEventRecord} returns this
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.setHeight = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.getPeriod = function() {
 ...
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEventRecord} returns this
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.setPeriod = function(value) {
 ...
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.getValidatorSlashEvent = function() {
  return /** @type{?proto.sgn.distribution.v1.ValidatorSlashEvent} */ (
    jspb.Message.getWrapperField(this, sgn_distribution_v1_distribution_pb.ValidatorSlashEvent, 4));
};


/**
 * @param {?proto.sgn.distribution.v1.ValidatorSlashEvent|undefined} value
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEventRecord} returns this
*/
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.setValidatorSlashEvent = function(value) {
 ...
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEventRecord} returns this
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.clearValidatorSlashEvent = function() {
 ...
 * @return {boolean}
 */
proto.sgn.distribution.v1.ValidatorSlashEventRecord.prototype.hasValidatorSlashEvent = function() {
 ...
 * @const
 */
proto.sgn.distribution.v1.GenesisState.repeatedFields_ = [3,5,6,7,8,9,10];
...
proto.sgn.distribution.v1.GenesisState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.sgn.distribution.v1.ValidatorSlashEventRecord.toObject, includeInstance)
  };
...
proto.sgn.distribution.v1.GenesisState.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = new proto.sgn.distribution.v1.ValidatorSlashEventRecord;
      reader.readMessage(value,proto.sgn.distribution.v1.ValidatorSlashEventRecord.deserializeBinaryFromReader);
...
proto.sgn.distribution.v1.GenesisState.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      10,
      f,
      proto.sgn.distribution.v1.ValidatorSlashEventRecord.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.sgn.distribution.v1.ValidatorSlashEventRecord>}
 */
proto.sgn.distribution.v1.GenesisState.prototype.getValidatorSlashEventsList = function() {
  return /** @type{!Array<!proto.sgn.distribution.v1.ValidatorSlashEventRecord>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.sgn.distribution.v1.ValidatorSlashEventRecord, 10));
};


/**
 * @param {!Array<!proto.sgn.distribution.v1.ValidatorSlashEventRecord>} value
 * @return {!proto.sgn.distribution.v1.GenesisState} returns this
*/
proto.sgn.distribution.v1.GenesisState.prototype.setValidatorSlashEventsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 10, value);
};


/**
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEventRecord=} opt_value
 * @param {number=} opt_index
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEventRecord}
 */
proto.sgn.distribution.v1.GenesisState.prototype.addValidatorSlashEvents = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 10, opt_value, proto.sgn.distribution.v1.ValidatorSlashEventRecord, opt_index);
};
 ...
 * @return {!proto.sgn.distribution.v1.GenesisState} returns this
 */
proto.sgn.distribution.v1.GenesisState.prototype.clearValidatorSlashEventsList = function() {
