...
goog.exportSymbol('proto.sgn.distribution.v1.CBridgeFeeShareInfo', null, global);
...
goog.exportSymbol('proto.sgn.distribution.v1.ValidatorSlashEvent', null, global);
goog.exportSymbol('proto.sgn.distribution.v1.ValidatorSlashEvents', null, global);
/**
 ...
 * @constructor
 */
proto.sgn.distribution.v1.ValidatorSlashEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sgn.distribution.v1.ValidatorSlashEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sgn.distribution.v1.ValidatorSlashEvent.displayName = 'proto.sgn.distribution.v1.ValidatorSlashEvent';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.sgn.distribution.v1.ValidatorSlashEvents = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.sgn.distribution.v1.ValidatorSlashEvents.repeatedFields_, null);
};
goog.inherits(proto.sgn.distribution.v1.ValidatorSlashEvents, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sgn.distribution.v1.ValidatorSlashEvents.displayName = 'proto.sgn.distribution.v1.ValidatorSlashEvents';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.sgn.distribution.v1.CBridgeFeeShareInfo.repeatedFields_, null);
};
goog.inherits(proto.sgn.distribution.v1.CBridgeFeeShareInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sgn.distribution.v1.CBridgeFeeShareInfo.displayName = 'proto.sgn.distribution.v1.CBridgeFeeShareInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.sgn.distribution.v1.ValidatorSlashEvent.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEvent} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sgn.distribution.v1.ValidatorSlashEvent;
  return proto.sgn.distribution.v1.ValidatorSlashEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEvent}
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sgn.distribution.v1.ValidatorSlashEvent.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEvent} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.prototype.getValidatorPeriod = function() {
...
/**
 * @param {number} value
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEvent} returns this
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.prototype.setValidatorPeriod = function(value) {
 ...
 * @return {string}
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.prototype.getFraction = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEvent} returns this
 */
proto.sgn.distribution.v1.ValidatorSlashEvent.prototype.setFraction = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @const
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.prototype.toObject = function(opt_includeInstance) {
  return proto.sgn.distribution.v1.ValidatorSlashEvents.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEvents} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.toObject = function(includeInstance, msg) {
  var f, obj = {
    validatorSlashEventsList: jspb.Message.toObjectList(msg.getValidatorSlashEventsList(),
    proto.sgn.distribution.v1.ValidatorSlashEvent.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEvents}
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sgn.distribution.v1.ValidatorSlashEvents;
  return proto.sgn.distribution.v1.ValidatorSlashEvents.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEvents} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEvents}
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.sgn.distribution.v1.ValidatorSlashEvent;
      reader.readMessage(value,proto.sgn.distribution.v1.ValidatorSlashEvent.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sgn.distribution.v1.ValidatorSlashEvents.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sgn.distribution.v1.ValidatorSlashEvents} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.sgn.distribution.v1.ValidatorSlashEvent.serializeBinaryToWriter
    );
  }
};
 ...
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.prototype.getValidatorSlashEventsList = function() {
  return /** @type{!Array<!proto.sgn.distribution.v1.ValidatorSlashEvent>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.sgn.distribution.v1.ValidatorSlashEvent, 1));
};


/**
 * @param {!Array<!proto.sgn.distribution.v1.ValidatorSlashEvent>} value
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEvents} returns this
*/
proto.sgn.distribution.v1.ValidatorSlashEvents.prototype.setValidatorSlashEventsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEvent}
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.prototype.addValidatorSlashEvents = function(opt_value, opt_index) {
 ...
 * @return {!proto.sgn.distribution.v1.ValidatorSlashEvents} returns this
 */
proto.sgn.distribution.v1.ValidatorSlashEvents.prototype.clearValidatorSlashEventsList = function() {
 ...
 * @const
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.sgn.distribution.v1.CBridgeFeeShareInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sgn.distribution.v1.CBridgeFeeShareInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sgn.distribution.v1.CBridgeFeeShareInfo;
  return proto.sgn.distribution.v1.CBridgeFeeShareInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sgn.distribution.v1.CBridgeFeeShareInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sgn.distribution.v1.CBridgeFeeShareInfo}
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sgn.distribution.v1.CBridgeFeeShareInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sgn.distribution.v1.CBridgeFeeShareInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<!proto.cosmos.base.v1beta1.DecCoin>}
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.prototype.getClaimableFeeAmountsList = function() {
  return /** @type{!Array<!proto.cosmos.base.v1beta1.DecCoin>} */ (
    jspb.Message.getRepeatedWrapperField(this, cosmos_base_v1beta1_coin_pb.DecCoin, 1));
};
...
/**
 * @param {!Array<!proto.cosmos.base.v1beta1.DecCoin>} value
 * @return {!proto.sgn.distribution.v1.CBridgeFeeShareInfo} returns this
*/
proto.sgn.distribution.v1.CBridgeFeeShareInfo.prototype.setClaimableFeeAmountsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.cosmos.base.v1beta1.DecCoin}
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.prototype.addClaimableFeeAmounts = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.cosmos.base.v1beta1.DecCoin, opt_index);
};
 ...
 * @return {!proto.sgn.distribution.v1.CBridgeFeeShareInfo} returns this
 */
proto.sgn.distribution.v1.CBridgeFeeShareInfo.prototype.clearClaimableFeeAmountsList = function() {
